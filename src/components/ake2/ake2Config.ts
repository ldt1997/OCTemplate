...
export const ake2TemplateSpec = {
  ...
  layers: {
    ...
    collabText: { x: 255, y: 550, fontSize: 30, lineHeight: 36 },
    ...
    professionEnglish: { x: 526, y: 1798, fontSize: 20, lineHeight: 24, color: "#AC9B9B", gap: 10, arrowWidth: 16.5, arrowHeight: 8 },
